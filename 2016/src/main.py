"""
Main execution script for the 2016 electoral-topology / socioeconomic
analysis pipeline.

Data notes
----------
- Poverty  : 2015 survey year (closest prior to 2016 election).
             Davao Occidental has no 2015 estimate (province created in 2016);
             2018 value used as fallback.
- IRA dep. : FY2016 XLSX (actual 2016 data).
- Dynasty  : 2016 actual data — the only pipeline year with contemporaneous
             dynasty data. Five provinces missing (Compostela Valley, Davao
             Occidental, Dinagat Islands, Sulu, Tawi-Tawi); imputed from
             regional means.
...
def main():
    ...
    # -------------------------------------------------------------------
    pov_label = config.POVERTY_COL_LABEL    # "2015 Poverty Incidence"
